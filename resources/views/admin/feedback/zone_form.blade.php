        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><?php if(isset($rs->id) && $rs->id!=''){echo "Edit";}else{echo "Add";}?> Zone</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
             <form method="post" action="{{ url('admin/manage-zone/add') }}" enctype="multipart/form-data">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="zone_name" placeholder="Enter Zone" name="zone_name" value="{{ old('zone_name',@$rs->zone_name)}}">
                  <span class="text-danger">{{ $errors->first('zone_name') }}</span>
                </div>

                <div class="form-group">
                  <label for="exampleInputEmail1">Zone Image</label>
                  <input type="file" class="form-control" id="zone_image"  name="zone_image">
                  <span class="text-danger">{{ $errors->first('zone_image') }}</span>
                </div>
