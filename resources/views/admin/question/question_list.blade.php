        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <a class="btn btn-primary pull-right" href="{{ url('admin/manage-questions/add')}}">Add Question</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            @endif
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{ ($v1->status ==1) ? 'Active' :'Inactive'}}</td>
                  <td>
                    <a href="{{ url('admin/manage-questions/add').'/'.$v1->id }}" title="Edit" data-toggle="tooltip"><i class="fa fa-pencil"></i></a>

                    <a href="{{url('admin/manage-questions/delete'.'/'.$v1->id)}}" title="Remove" data-toggle="tooltip" onclick="return confirm('Are you sure do you want to delete?')"><i class="fa fa-remove text-danger"></i></a></td>
                </tr>
                @php
                  $i++;
                @endphp
